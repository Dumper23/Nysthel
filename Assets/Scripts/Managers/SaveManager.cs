...
public class SaveManager : MonoBehaviour
{
    ...
    public void loadGame()
    {
        if (File.Exists(path))
        {
            ...
            //Statue Stats
            SaveVariables.GOLD_STATUE = data.GOLD_STATUE;
            SaveVariables.HOLY_STATUE = data.HOLY_STATUE;
            SaveVariables.CHANCE_STATUE = data.CHANCE_STATUE;
            SaveVariables.EMMYR_STATUE = data.EMMYR_STATUE;
            SaveVariables.DAMAGE_STATUE = data.DAMAGE_STATUE;
            SaveVariables.ACTIVATED_STATUES = data.ACTIVATED_STATUES;

            SaveVariables.TALKED_GROMODIN = data.TALKED_GROMODIN;
            SaveVariables.TALKED_HALLBORG = data.TALKED_HALLBORG;
            SaveVariables.TALKED_VORDKOR = data.TALKED_VORDKOR;
            SaveVariables.HAS_EMMYR_ITEM = data.HAS_EMMYR_ITEM;
